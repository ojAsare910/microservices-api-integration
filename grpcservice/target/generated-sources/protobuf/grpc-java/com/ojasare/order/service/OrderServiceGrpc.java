...
public final class OrderServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.ojasare.order.service.OrderRequest,
      com.ojasare.order.service.OrderResponse> getCreateOrderMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateOrder",
      requestType = com.ojasare.order.service.OrderRequest.class,
      responseType = com.ojasare.order.service.OrderResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.ojasare.order.service.OrderRequest,
      com.ojasare.order.service.OrderResponse> getCreateOrderMethod() {
    io.grpc.MethodDescriptor<com.ojasare.order.service.OrderRequest, com.ojasare.order.service.OrderResponse> getCreateOrderMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getCreateOrderMethod = OrderServiceGrpc.getCreateOrderMethod) == null) {
          OrderServiceGrpc.getCreateOrderMethod = getCreateOrderMethod =
              io.grpc.MethodDescriptor.<com.ojasare.order.service.OrderRequest, com.ojasare.order.service.OrderResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateOrder"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ojasare.order.service.OrderRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.ojasare.order.service.OrderResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void createOrder(com.ojasare.order.service.OrderRequest request,
        io.grpc.stub.StreamObserver<com.ojasare.order.service.OrderResponse> responseObserver) {
  ...
  public static final class OrderServiceStub
    ...
    /**
     */
    public void createOrder(com.ojasare.order.service.OrderRequest request,
        io.grpc.stub.StreamObserver<com.ojasare.order.service.OrderResponse> responseObserver) {
  ...
  public static final class OrderServiceBlockingStub
    ...
    /**
     */
    public com.ojasare.order.service.OrderResponse createOrder(com.ojasare.order.service.OrderRequest request) {
  ...
  public static final class OrderServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.ojasare.order.service.OrderResponse> createOrder(
        com.ojasare.order.service.OrderRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_ORDER:
          serviceImpl.createOrder((com.ojasare.order.service.OrderRequest) request,
              (io.grpc.stub.StreamObserver<com.ojasare.order.service.OrderResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.ojasare.order.service.OrderRequest,
              com.ojasare.order.service.OrderResponse>(
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.ojasare.order.service.OrderServiceOuterClass.getDescriptor();
    }
